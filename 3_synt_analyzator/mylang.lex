...
([1-9][0-9]*)|0     {integer=process_pattern(integer,"NonZero detected.", PATT_INT); yylval = atoi(yytext);   
                    return INT;}
                
([1-9][0-9]*)(\.[0-9]+)? {float_val=process_pattern(float_val,"Integer detected.", PATT_FLOAT); yylval = atoi(yytext);           
                    return FLOAT;}
